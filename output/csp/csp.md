...
![Example of averaged sample covariance matrices (SCMs).](./assets/scms.png)
...
![The averaged SCMs summed.](./assets/scms-summed.png)
...
![Both the whitened sum of the SCMs and the sum of each SCM transformed by the whitening matrix equals the identity matrix.](./assets/scms-transformed.png)
