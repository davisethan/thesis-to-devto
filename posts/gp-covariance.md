...
![Example functions drawn from a GP prior with the squared exponential (left) and linear (right) covariance functions](assets/gp-covariance/cov-grid.png)
*Example functions drawn from a GP prior with a given covariance function. (Left) The squared exponential covariance function. (Right) The linear covariance function [2].*

![Samples from additional covariance functions: Matérn 5/2, Matérn 3/2, exponential, and polynomial](assets/gp-covariance/cov-additional-grid.png)
*Samples from additional covariance functions. (Top Left) The Matérn 5/2 kernel. (Top Right) The Matérn 3/2 kernel. (Bottom Left) The exponential kernel. (Bottom Right) The polynomial kernel [2].*
