...
{% katex %}
(z) = \int_ {\mathbb{R}^ D}f(u)g(z-u)\mathrm{d}u.
{% endkatex %}
...
{% katex %}
(i) = w_ {-L}x_ {i+L}+\cdots+w_ {-1}x_ {i+1}+w_ 0x_ i+w_ 1x_ {i-1}+\cdots+w_ Lx_ {i-L}.
{% endkatex %}
...
{% katex %}
(i,j) = \sum_ {u=0}^ {H-1}\sum_ {v=0}^ {W-1}w_ {u,v}x_ {i+u,j+v}.
{% endkatex %}
...
![The first 6 of 25 convolutions with padding [2].](assets/dnn-cnn/pns-frame00.png)

![The first 6 of 25 convolutions with padding [2].](assets/dnn-cnn/pns-frame01.png)

![The first 6 of 25 convolutions with padding [2].](assets/dnn-cnn/pns-frame02.png)

  

![The first 6 of 25 convolutions with padding [2].](assets/dnn-cnn/pns-frame03.png)

![The first 6 of 25 convolutions with padding [2].](assets/dnn-cnn/pns-frame04.png)

![The first 6 of 25 convolutions with padding [2].](assets/dnn-cnn/pns-frame05.png)
...
![The first 6 in 9 convolutions with padding and strides [2].](assets/dnn-cnn/ps-frame00.png)

![The first 6 in 9 convolutions with padding and strides [2].](assets/dnn-cnn/ps-frame01.png)

![The first 6 in 9 convolutions with padding and strides [2].](assets/dnn-cnn/ps-frame02.png)

  

![The first 6 in 9 convolutions with padding and strides [2].](assets/dnn-cnn/ps-frame03.png)

![The first 6 in 9 convolutions with padding and strides [2].](assets/dnn-cnn/ps-frame04.png)

![The first 6 in 9 convolutions with padding and strides [2].](assets/dnn-cnn/ps-frame05.png)
