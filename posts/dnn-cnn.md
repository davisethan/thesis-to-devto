...
![Convolution with zero-padding — six frames of the sliding filter (of a 25-step animation) [3].](assets/dnn-cnn/padding-grid.png)
...
![Strided convolution with zero-padding — six frames (of a 9-step animation) [3].](assets/dnn-cnn/strides-grid.png)
